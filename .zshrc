...
plugins=(git z jsontools history python sublime vscode xcode osx colored-man-pages colorize ruby rbenv zsh-syntax-highlighting zsh-autosuggestions gitignore git-prompt)
