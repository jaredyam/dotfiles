...
plugins=(git z jsontools history python sublime vscode xcode macos colored-man-pages colorize ruby rbenv zsh-syntax-highlighting zsh-autosuggestions gitignore git-prompt)
...
# conda activate environment with fzf auto-prompting
function condaf() {
  . activate && conda activate $(conda info --env | fzf | awk '{print $NF}')
}
