...
plugins=(git sudo z jsontools history python sublime vscode xcode macos colored-man-pages colorize ruby rbenv zsh-syntax-highlighting zsh-autosuggestions gitignore git-prompt poetry)
